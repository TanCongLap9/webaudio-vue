...
<template>
    <NodeComponent :index="index" :model="model" :is-removable="true">
        <div class="mb-3">
        ...
        <template v-if="isTypeCustom">
            <div class="mb-3">
                <label :for="`periodicwave-length-${index}`" class="form-label">length</label>
